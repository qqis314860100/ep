...
const GovernanceResponsibilityPage = lazy(() => import('./features/governance/responsibility/GovernanceResponsibilityPage').then(module => ({ default: module.GovernanceResponsibilityPage })))
