...
vi.mock('../api', async importOriginal => ({ ...await importOriginal<typeof import('../api')>(), getCurrentConfirmation: vi.fn(), getGovernanceItems: vi.fn(), saveConfirmationDecision: vi.fn(), completeConfirmation: vi.fn() }))
