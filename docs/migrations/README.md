...
1. Apply the schema in a non-production OceanBase environment.
   Apply `V1_8__governance_standard_center.sql`, `V1_9__governance_mapping_rules.sql`, and then `V1_10__governance_scan_runs.sql` after the V1.7 governance closed-loop schema.
